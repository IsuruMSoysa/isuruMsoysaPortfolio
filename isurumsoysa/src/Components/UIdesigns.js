...
function UIdesigns() {
    return (
        <Container >
            <Row className="project-row px-4">
                <Col className="abt-tab-col my-2 py-3 px-4 mx-2">
                    ...
                    <div className="pt-3">
                        ...
                        <h6><b>Watch the UX/UI Prototype Design Demonstration which designed using <span style={{color:"#6F10B4"}}>
                ...
                <Col className="abt-tab-col my-2 py-3 px-4 mx-2">
                    ...
                    <div className="pt-3">
                        <h6 style={{color:"#454545"}}>
                            ...
                            portfolio website. I was the <span style={{color:"#6F10B4"}}> front-end developer</span>
                            of this project and <span style={{color:"#6F10B4"}}>  I used HTML, CSS, and Bootstrap </span>
                            for the front end. This is a <span style={{color:"#6F10B4"}}> responsive website and the first
            ...
            <Col className="abt-tab-col my-2 py-3 px-4 mx-2">
                <div className="abt-tab px-1">
                    <h4 style={{color:"#6F10B4"}}>Malinga Herath Photography (Web Application)</h4>
                </div>
                <div className="pt-3">
                    <h6 style={{color:"#454545"}}>
                        ...
                        <span style={{color:"#6F10B4"}}> front-end developer</span> to this project.<br/>
                        The speciality behind this project was the front-end developed using
                        <span style={{color:"#6F10B4"}}> only HTML and CSS.</span>
                    </h6><br/>
                    <h6>
                            <span style={{color:"#6F10B4"}}>
            ...
            <Row className="project-row my-3 px-4">
                <Col className="abt-tab-col my-2 py-3 px-4 mx-2">
                    <div className="abt-tab px-1">
                        <h4 style={{color:"#6F10B4"}}>IM ASSIST (Mobile Application)</h4>
                    </div>
                    <div className="pt-3">
                        <h6 style={{color:"#454545"}}>
                            ...
                            <span style={{color:"#6F10B4"}}> UX/UI Designer and a Front-end developer</span> of this project.<br/>
                            For the front-end, we have used
                            <span style={{color:"#6F10B4"}}>Xamarin Forms, C#, and Visual Studio IDE.</span>
            ...
            <Row className="project-row my-3 px-4">
                <Col className="abt-tab-col my-2 py-3 px-4 mx-2">
                    <div className="abt-tab px-1">
                        <h4 style={{color:"#6F10B4"}}>Liyane Arts (Web Application)</h4>
                    </div>
                    <div className="pt-3">
                        <h6 style={{color:"#454545"}}>
                            <h5><b>Responsive Portfolio Website</b></h5><br/>
                            This was one of my first projects contributed as the
                            <span style={{color:"#6F10B4"}}> Front-end developer</span>
                            The specialty of this project is <span style={{color:"#6F10B4"}}>
